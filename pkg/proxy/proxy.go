...
func NewProxy(cfg Config) *Proxy {
	...
	// Read-only depth probe for the split summary: a synthetic queue that is
	// still occupied after an un-split invalidates the arm, and that has to be
	// visible on the line the run is read from. → uplinksplit.go
