...
- можно изменить количество соединений, от этого параметра зависит общая скорость работы с Интернет (на 30 соедиениях в идеальных условиях можно получить 50+ Мбит/сек). Максимальное количество - 60.
